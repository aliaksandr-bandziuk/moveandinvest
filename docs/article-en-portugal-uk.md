...
Their thresholds, article numbers and what each actually requires are in [the Portugal residence guide](entry:portugal-residency), [the D8 page](entry:portugal-nomad) and [the golden visa page](entry:portugal-golden-visa). None of it changes because the applicant is British, and repeating it here would only make this page longer than the thing it exists to say.
...
The more consequential question is when those ten years start, and the answer changed on 19 May 2026 — a paragraph that let time in the AIMA queue count was repealed. That is set out with the repealing provision in [Portugal's nationality law](entry:portugal-citizenship), and worked through for a non-EU applicant in [moving to Portugal from the US](entry:portugal-americans), which is the same arithmetic. You can put your own dates into our [naturalisation clock](/naturalisation-clock).
...
**Head terms:**
moving to portugal from the uk, moving to portugal from uk, british moving to portugal, uk citizen moving to portugal, moving to portugal from uk requirements, british citizens moving to portugal

**Mid-tail:**
uk portugal double taxation treaty, uk portugal tax treaty 2025, moving to portugal from uk tax, portugal residency for uk citizens, moving to portugal from uk after brexit, uk pension tax in portugal, portuguese citizenship for uk citizens, moving to portugal from uk d7 visa
...
**Кластер.** `moving to portugal from the uk` — 1 900 при конкуренции 54 и CPC
$3,84; схлопнуто 2 340 против наивной суммы 6 150. Тренд **−46**, как и у
американского кластера: оба не растут. `moving to portugal from ireland` (170)
лежит в том же файле выгрузки и сюда **не входит** — ирландец гражданин ЕС, у
него другое положение, и смешивать нельзя.

**Форма выдачи.** GOV.UK своим гайдом, две транспортные компании, Wise,
британская иммиграционная фирма, imin-portugal, Reddit дважды, Facebook и
Blevins Franks. Специалистов по португальскому праву нет вообще — форма наша,
но конкуренция 54 идёт от рекламных ставок, а не от содержания.

**Почему стержень не тот, что у D1.** Британия облагает по резидентству, а не по
гражданству, так что американская конструкция «страна выезда не отпускает» здесь
неприменима. Взяли то, чего нет ни у кого: смена конвенции 2025 года и
разъехавшиеся даты применения.

**Два утверждения были написаны и убиты на проверке** — обстоятельства в
`portugal-uk-verification-2026-09-08.md`. Коротко: сводка HMRC не устарела, её
надо читать со стороны британского резидента; и новый договор **не** развернул
налогообложение пенсий — статья 17 договора 1968 года говорит то же самое.
Второе чуть не стало заголовком.

**Что забирает у соседей.** Ничего. Маршруты, пороги и натурализация остаются на
своих страницах, ссылки идут отсюда туда.
