...
**Slug:** `portugal-digital-nomad-visa-d8`
**Language:** en
...
`Portugal D8 digital nomad visa: two visas, one euro figure`

**Meta description (147 characters):**
`One name, two visas, and the same income test. The regulation naming the in-country route still points at paragraphs repealed on 4 June 2024.`
...
1. `Two columns comparing Portugal's two digital nomad visas. The temporary-stay visa rests on article 54(1)(i), lasts under a year, allows multiple entries, is documented by article 18-B of the regulation, does not lead to a residence permit and does not appear in the conversion list of article 122. The residence visa rests on article 61-B, is documented by article 31-A, leads to a residence permit and to the naturalisation clock. Both require the same income: four minimum wages averaged over three months.`
2. `A five-step chain of dates. In September 2022 the regulation inserts article 31-A, whose second paragraph sends an applicant without the visa to the procedure of articles 88 and 89. In January 2024 the regulation is amended for the last time, without touching it. In June 2024 a decree-law repeals paragraph 2 of article 88 and paragraphs 2, 4 and 5 of article 89. In November 2024 a law widens the transitional protection but restores nothing. In October 2025 article 89 receives a new paragraph 4 about business incubators. The cross-reference is still in force and still points at the repealed text.`
...
3. Open Decreto-Lei 37-A/2024 and read article 2. It names those paragraphs.
4. Check the amendment list of Decreto Regulamentar 84/2007. The last entry is January 2024, before the repeal.
5. Read article 122(1) of Lei 23/2007 to the end of the alíneas, and look for the remote worker. Paragraph (q) is the nearest thing there, and it is a different visa.

Every instrument named here has its own line and its own link on our [sources page](/sources#pt).
...
**Head terms:**
portugal digital nomad visa, portugal d8 visa, d8 visa portugal, portugal digital nomad visa requirements, portugal remote work visa, digital nomad visa portugal 2026

**Mid-tail:**
portugal d8 visa income requirement, portugal digital nomad visa income, d8 temporary stay visa portugal, portugal digital nomad visa vs d7, portugal remote worker residence visa, portugal d8 visa application, article 61-b lei 23/2007, portugal digital nomad visa minimum salary
...
income-статья; разводить будем там, если спрос вырастет.

**Что эта страница забирает.** У `portugal-residency` уезжает весь блок D8:
`portugal d8 visa income requirement`, `portugal remote work visa` и вопрос про
четыре минимальные зарплаты. За `portugal-residency` остаётся D7, золотая виза и
сравнение маршрутов — там D8 сокращается до одной строки в таблице и ссылки
сюда. У `income-cost-of-living` остаётся кросс-юрисдикционное сравнение порогов
дохода, но португальский раздел про D8 тоже сокращается до ссылки.
