...
`Moving to Portugal from the US: what the dates really are`

**Meta description (149 characters):**
`Ten years to citizenship, but counted from when? A paragraph repealed on 19 May 2026 decides it. Plus where the tax treaty actually hides its saving clause.`
...
You can put your own dates into our [naturalisation clock](/naturalisation-clock), which carries both.

### The visa routes for Americans moving to Portugal are not on this page

There is no US-specific route into Portugal. An American is a third-country national and uses the ordinary ones: the D7 for passive income, the D8 for remote work, the investment permit. Their thresholds, their article numbers and what each does and does not require are in [the Portugal residence guide](entry:portugal-residency), the [D8 page](entry:portugal-nomad) and [the golden visa page](entry:portugal-golden-visa). The full naturalisation picture is in [Portugal's nationality law](entry:portugal-citizenship). None of it changes because the applicant is American, and this page does not repeat it.
...
Every Portuguese instrument named here has its own line, with the date it was read, on [our sources page](/sources#pt).
...
**Head terms:**
moving to portugal from the us, moving to portugal from usa, americans moving to portugal, moving to portugal as an american, us citizen moving to portugal, moving to portugal from the united states

**Mid-tail:**
us portugal tax treaty, portugal citizenship for americans, how long to get portuguese citizenship, moving to portugal from usa requirements, americans moving to portugal taxes, us portugal totalization agreement, portugal residence permit for americans, portuguese citizenship ten years
...
«What we are not going to do on this page», «One page we did open» — драматургия
без единого термина. Переписаны в тот же день.

**Английская страница, и другой аудитории у неё быть не может.**

**Кластер и его состояние.** `moving to portugal from the us` — 2 900 при
конкуренции 55 и CPC $3,15; схлопнутый кластер 4 170 против наивной суммы 9 970.
Три формулировки головы («from the us», «from us», «from usa») — одна группа
Google. **Тренд минус 47 у головы и минус 46…57 у всех значимых соседей**: по
месяцам уровень держался до января 2026-го и просел после. Кластер не растущий,
и это надо помнить, оценивая отдачу.

**Форма выдачи смешанная.** Reddit первым, дальше посольство США, Taxes for
Expats, финансовые консультанты, ролик, Facebook, Get Golden Visa, транспортная
компания. Специалисты сюда проходят — форма наша, — но три верхних слота у
сообществ.

**Почему стержень не тот, что в греческой статье.** У Taxes for Expats на
пересечении «США плюс Португалия» стоит целый куст: отдельные страницы про
налоговое соглашение, про NHR 2.0 для американцев, про D8 для американцев, про
налоги при двойном гражданстве. Приём «два инструмента, которых нет ни у кого»
здесь применять нельзя — и в тексте это сказано прямо, вместе с именем фирмы.
Поэтому стержень — часы: отмена пункта 4 статьи 15 и два режима подсчёта. Второй
слой — оговорка о сохранении права, и её ценность не в существовании, а в
местоположении: она в Протоколе, а не в статье 1.

**Что забирает у соседей.** Ничего. Маршруты, пороги, D8, золотая виза и полная
картина натурализации остаются на своих страницах, ссылки идут отсюда туда.
Страница держит только американскую специфику.
