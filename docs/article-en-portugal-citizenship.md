...
`Portugal nationality law 2026: the text, article by article`

**Meta description (149 characters):**
`Lei Organica 1/2026 doubled the period and repealed the paragraph that made queue time count. Both changes, quoted from the Diario da Republica text.`
...
1. `Three bars on one axis measuring years from the day temporary residence was applied for. A nationality file pending on 19 May 2026 reaches citizenship at five years, with the three-year permit queue counted inside that period. A file opened after that date reaches it at ten years for citizens of the EU and Portuguese-speaking countries and at thirteen for every other nationality, because the same three-year queue now sits outside the period instead of inside it.`
2. `The five conditions of article 6(1) with a status against each. Legal age is unchanged. Seven or ten years of legal residence is marked doubled in 2026. Sufficient knowledge of the language and of Portuguese culture, history and symbols is marked widened. Sufficient knowledge of the rights and duties of nationality and of the state, and a solemn declaration of adherence to the principles of the democratic rule of law, are both marked new in 2026.`
...
^ The same applicant, filed on either side of 19 May 2026
...
3. Find article 5, the repealing provision. Read to the end of the sentence, past the article 9 and article 12-B items, until you reach "o n.º 4 do artigo 15.º".
4. Find article 7(2). That tells you which of the two columns above you are in.
5. If a page you are reading gives a period without naming this law, you now know something the page does not.
...
Sources for every act named on this page, with the verdict each one produced and the date it was last read, are on [the sources page](/sources#citizenship-lei-organica-1-2026).
...
**Head terms:**
portugal nationality law, portuguese nationality law, portugal citizenship law, portuguese citizenship, portugal citizenship, portuguese nationality, portugal citizenship requirements

**Mid-tail:**
portugal citizenship 10 years, portugal citizenship law change, lei organica 1/2026, portugal nationality act, portugal citizenship by naturalisation, portugal citizenship residence requirement, portugal new citizenship law 2026, portugal ten years citizenship 2026 law change, how long to get portuguese citizenship
...
`portugal-move`, и разводить надо там, а не задним числом отсюда.

**Что эта страница забирает и чего не забирает.** Забирает закон:
`portugal nationality law` (2 900, конкуренция 2), `portugal citizenship law`
(880, конкуренция 7, самый дорогой клик в проекте). Не забирает
`portuguese citizenship by descent` и `by marriage` — это другие статьи закона
и отдельные страницы; ни одного подзаголовка под них здесь нет специально.
`portugal golden visa` остаётся за `portugal-golden-visa`: отсюда туда ссылка,
не наоборот.
