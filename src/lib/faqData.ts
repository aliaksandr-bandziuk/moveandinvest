    ...
    items: [
      ...
      },
      {
        ...
        a: {
          ...
          ru: "ОАЭ — и порядок отличается от предыдущего ответа, ради чего оба вопроса и заданы. Сверх самой инвестиции: ОАЭ — около €31 000 государственных сборов (AED 9 884,75 плюс AED 5 774,50 за иждивенца; регистрационные 4% и комиссия агента 2% названы, но не сложены, потому что официальная страница их не подтверждает). Греция — около €34 000 на уровне €400 000 и около €67 000 на €800 000. Португалия — примерно €30 000–50 000 на одного и €65 000–90 000 на семью из трёх, вместе с юристом и комиссиями фонда. Мальта — около €126 000 сверх цены объекта, и это с отрывом больше всех: в основном административный сбор €60 000 и взнос €37 000.",
          pl: "ZEA — i kolejność różni się od poprzedniej odpowiedzi, po to oba pytania zadano. Ponad samą inwestycję: ZEA około €31 000 opłat państwowych (AED 9 884,75 plus AED 5 774,50 za osobę zależną; 4% rejestracyjne i 2% prowizji agenta wymieniono, ale nie zsumowano, bo żadna oficjalna strona ich nie potwierdza). Grecja około €34 000 na poziomie €400 000 i około €67 000 na €800 000. Portugalia mniej więcej €30 000–50 000 dla jednej osoby i €65 000–90 000 dla rodziny trzyosobowej, wraz z prawnikiem i prowizjami funduszu. Malta około €126 000 ponad cenę nieruchomości — najwięcej tutaj z dużym marginesem, głównie opłata administracyjna €60 000 i wkład €37 000.",
        },
      },
      {
        key: "fastest",
