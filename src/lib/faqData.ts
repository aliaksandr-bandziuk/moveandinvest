  ...
  // structurally cannot say, because an agency sells one of the five.
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: {
          en: "The UAE, and not narrowly: title deed to Emirates ID runs about two to four weeks, against published figures of 7–10 working days at the DLD and about 5 at GDRFA. Greece sets two months in article 100 §10 and misses it, but a βεβαίωση at filing already confers lawful residence and the permit's rights until a decision — in November 2025 there were 13,499 cases pending, 10,703 of them in Attica. Portugal is the slow one and the gap is not small: the statute allows 60 days for a grant, and in practice it runs one to three years, with roughly 30,000 cases pending at AIMA on 4 August 2026. For Malta we state nothing — no primary source publishes a processing time, so the widely quoted “4–6 months” is not something we will repeat.",
          ru: "ОАЭ, и с большим отрывом: от свидетельства о праве до Emirates ID проходит примерно две-четыре недели, при заявленных 7–10 рабочих днях у DLD и около 5 у GDRFA. В Греции закон даёт два месяца по ст. 100 §10 и в этот срок не укладывается, но выдаваемая при подаче βεβαίωση сама по себе даёт законное пребывание и права по разрешению до решения; на ноябрь 2025 года нерассмотренных дел было 13 499, из них 10 703 в Аттике. Португалия — медленная, и разрыв немаленький: закон даёт 60 дней на выдачу, на практике проходит от года до трёх, а на 4 августа 2026 года у AIMA было около 30 000 нерассмотренных дел. По Мальте мы не говорим ничего: срок рассмотрения не публикует ни один первоисточник, поэтому ходовые «4–6 месяцев» мы повторять не будем.",
          pl: "ZEA, i to z dużą przewagą: od aktu własności do Emirates ID mija około dwóch do czterech tygodni, przy podawanych 7–10 dniach roboczych w DLD i około 5 w GDRFA. Grecja ma ustawowy termin dwóch miesięcy w art. 100 §10 i go nie dotrzymuje, ale wydawana przy złożeniu βεβαίωση sama daje legalny pobyt i prawa z zezwolenia do czasu decyzji; w listopadzie 2025 czekało 13 499 spraw, z czego 10 703 w Attyce. Portugalia jest wolna, a różnica niemała: ustawa daje 60 dni na wydanie, w praktyce mija rok do trzech, a 4 sierpnia 2026 AIMA miała około 30 000 nierozpatrzonych spraw. O Malcie nie mówimy nic: żadne źródło pierwotne nie publikuje czasu rozpatrywania, więc obiegowych „4–6 miesięcy” nie będziemy powtarzać.",
        },
      },
      {
    ...
    items: [
      {
        ...
        a: {
          en: "Because the published number is usually the statutory deadline and the real one is the queue. Portugal is the clearest case on this site: article 82 allows 60 days to decide a grant and 30 to decide a renewal, and in practice filing to biometrics runs 6–24 months and biometrics to card another 6–18, with roughly 30,000 cases pending at AIMA on 4 August 2026. Both numbers are true and only one describes your year. Greece removes the sting differently — its statute sets two months in article 100 §10 and the queue has run well past that, but the confirmation issued when you file already confers lawful residence and the permit's rights until a decision comes, which is why a long Greek wait costs less than a long Portuguese one.",
          ru: "Потому что публикуемая цифра — обычно законный срок, а реальная — очередь. Португалия здесь самый наглядный случай: ст. 82 даёт 60 дней на решение о выдаче и 30 — о продлении, а на практике от подачи до биометрии проходит 6–24 месяца и от биометрии до карты ещё 6–18, при примерно 30 000 нерассмотренных дел у AIMA на 4 августа 2026 года. Обе цифры верны, но год описывает только одна. Греция снимает остроту иначе: её закон даёт два месяца по ст. 100 §10, и очередь давно идёт мимо этого срока, но выдаваемая при подаче справка уже даёт законное пребывание и права по разрешению до решения — поэтому долгое греческое ожидание стоит меньше, чем долгое португальское.",
          pl: "Bo publikowana liczba to zwykle termin ustawowy, a rzeczywista to kolejka. Portugalia jest tu najwyraźniejszym przypadkiem: art. 82 daje 60 dni na decyzję o wydaniu i 30 na decyzję o przedłużeniu, a w praktyce od złożenia do biometrii mija 6–24 miesiące i od biometrii do karty kolejne 6–18, przy około 30 000 spraw czekających w AIMA na 4 sierpnia 2026. Obie liczby są prawdziwe, ale rok opisuje tylko jedna. Grecja zdejmuje ostrze inaczej: jej ustawa daje dwa miesiące w art. 100 §10, a kolejka od dawna go przekracza, ale zaświadczenie wydawane przy złożeniu już daje legalny pobyt i prawa z zezwolenia do czasu decyzji — dlatego długie greckie oczekiwanie kosztuje mniej niż długie portugalskie.",
        },
      },
      {
        key: "how-many-trips",
  ...
  // /sources need somewhere to be explained rather than buried.
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: {
          en: "Seven, and naming them is the point of this answer. Malta's processing time — no primary source publishes one, so the widely quoted four to six months appears nowhere on this site. Whether off-plan property qualifies in the UAE — rechecked across four authorities on 25 August 2026, still nothing in either direction. Two Cypriot figures: the threshold in its regulation 6(2) and the reduced VAT rate with its limits. And where a Portugal D7 application is actually filed, consulate or VFS Global, which is stated only on ministry hosts that did not answer. And two Polish ones: an average waiting time for a residence permit, where the only official figures are years old, and the fee for a CUKR permit, where the UdSC page and the stamp duty act point in different directions. Each of those is a question we get asked and could answer plausibly in one sentence. A plausible answer is what everyone else publishes, and it is indistinguishable from a true one right up until it costs somebody money.",
          ru: "Семь — и назвать их и есть смысл этого ответа. Срок рассмотрения на Мальте: его не публикует ни один первоисточник, поэтому ходовые «четыре-шесть месяцев» на этом сайте не встречаются нигде. Годится ли в ОАЭ объект на стадии строительства: перепроверено по четырём ведомствам 25 августа 2026 года — по-прежнему ничего ни за, ни против. Две кипрские: порог в регламенте 6(2) и пониженная ставка НДС с её пределами. И куда подаётся заявление на португальскую D7, в консульство или через VFS Global: это сказано только на узлах министерства, которые не отвечали. И две польские: средний срок рассмотрения разрешения на пребывание, по которому официальные цифры есть только многолетней давности, и сбор за разрешение при CUKR, по которому страница UdSC и закон о гербовом сборе расходятся. Каждый из этих вопросов нам задают, и на каждый можно правдоподобно ответить одной фразой. Правдоподобный ответ — это то, что публикуют все остальные, и он неотличим от верного ровно до того момента, когда обойдётся кому-то в деньги.",
          pl: "Siedmiu — a ich nazwanie jest sensem tej odpowiedzi. Czas rozpatrywania na Malcie: nie publikuje go żadne źródło pierwotne, więc obiegowe „cztery do sześciu miesięcy” nie pojawia się na tej stronie nigdzie. Czy w ZEA kwalifikuje się nieruchomość w budowie: sprawdzone ponownie w czterech urzędach 25 sierpnia 2026 — nadal nic ani za, ani przeciw. Dwie cypryjskie: próg z rozporządzenia 6(2) oraz obniżona stawka VAT wraz z jej limitami. I gdzie faktycznie składa się wniosek o portugalską D7, w konsulacie czy przez VFS Global: podają to wyłącznie serwery ministerstwa, które nie odpowiadały. I dwie polskie: średni czas rozpatrywania wniosku o zezwolenie pobytowe, dla którego oficjalne liczby są sprzed lat, oraz opłata za zezwolenie przy karcie CUKR, co do której strona UdSC i ustawa o opłacie skarbowej się rozchodzą. O każde z tych pytań nas pytają i na każde da się prawdopodobnie odpowiedzieć jednym zdaniem. Prawdopodobna odpowiedź to właśnie to, co publikują wszyscy inni, i jest nie do odróżnienia od prawdziwej dokładnie do chwili, gdy kogoś kosztuje pieniądze.",
        },
      },
    ],
  },
...
const STATED_COUNTS = { checks: 61, corrected: 19, unverified: 7 };
