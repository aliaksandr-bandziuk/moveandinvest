import { documentTypes, enquiry, partnerEnquiry } from "./documents";
import { objectTypes } from "./objects";

export const schemaTypes = [...objectTypes, ...documentTypes];

// The schema for the private enquiries dataset. Two types, no objects:
...
export const enquirySchemaTypes = [enquiry, partnerEnquiry];
