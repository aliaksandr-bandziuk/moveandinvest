...
// the component, and research/costmodel-verification-2026-09-02.md for the data
...
function buildLabels(t: Translator): CostCalculatorLabels {
  ...
  return {
    ...
    // THE ONLY QUESTION. See research/calculator-spec-2026-09-03.md: a programme's
...
export default async function Calculator({
  ...
  return (
    <>
      ...
      {/* THE DATE, DERIVED. research/competitors-strengths-2026-09-02.md names the
