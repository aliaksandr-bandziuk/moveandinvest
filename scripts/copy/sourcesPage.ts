...
export const SOURCES_PAGE_COPY: Record<Locale, SourcesPageCopy> = {
  en: {
    ...
    seo: {
      ...
      metaDescription:
        "The full working behind the comparison: 74 checks against statutes and ministry tariffs, 19 of which corrected a figure. Citations, links and what could not be verified.",
    },
  },
  ru: {
    eyebrow: "Выкладки",
    ...
    intro:
      "Каждая заголовочная цифра здесь перечитана из закона, тарифа ведомства или официальной таблицы сборов, на которых она должна стоять. Семьдесят четыре проверки. Девятнадцать вернулись неверными, шесть не удалось установить ни по одному первоисточнику — и эти шесть нигде на сайте цифрами не публикуются. Первый заход был 23 августа 2026 года; у каждой перечитанной с тех пор строки стоит своя дата. Ниже всё, включая то, что нас не красит.",
    howToRead:
    ...
    seo: {
      ...
      metaDescription:
        "Полные выкладки за сравнением: 74 сверки с законами и тарифами ведомств, девятнадцать из которых исправили цифру. Ссылки на законы и то, что подтвердить не удалось.",
    },
  },
  pl: {
    eyebrow: "Wyliczenia",
    ...
    intro:
      "Każda główna liczba została tu odczytana na nowo z ustawy, taryfy ministerialnej albo oficjalnej tabeli opłat, na których ma się opierać. Siedemdziesiąt cztery sprawdzenia. Dziewiętnaście wróciło błędnych, sześciu nie udało się ustalić z żadnego źródła pierwotnego — i tych sześciu nigdzie na stronie nie publikujemy jako liczb. Pierwsze posiedzenie było 23 sierpnia 2026; każdy czytany od tego czasu wiersz nosi własną datę. Poniżej wszystko, łącznie z tym, co nas nie zdobi.",
    howToRead:
    ...
    seo: {
      ...
      metaDescription:
        "Pełne wyliczenia stojące za porównaniem: 74 sprawdzenia wobec ustaw i taryf ministerialnych, z czego dziewiętnaście poprawiło liczbę. Odesłania do przepisów i to, czego nie udało się potwierdzić.",
    },
  },
};
