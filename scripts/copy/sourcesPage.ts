...
export const SOURCES_PAGE_COPY: Record<Locale, SourcesPageCopy> = {
  en: {
    ...
    seo: {
      ...
      metaDescription:
        "The full working behind the comparison: 78 checks against statutes and ministry tariffs, 19 of which corrected a figure. Citations, links and what could not be verified.",
    },
  },
  ru: {
    eyebrow: "Выкладки",
    ...
    seo: {
      ...
      metaDescription:
        "Полные выкладки за сравнением: 78 сверок с законами и тарифами ведомств, девятнадцать из которых исправили цифру. Ссылки на законы и то, что подтвердить не удалось.",
    },
  },
  pl: {
    eyebrow: "Wyliczenia",
    ...
    seo: {
      ...
      metaDescription:
        "Pełne wyliczenia stojące za porównaniem: 78 sprawdzeń wobec ustaw i taryf ministerialnych, z czego dziewiętnaście poprawiło liczbę. Odesłania do przepisów i to, czego nie udało się potwierdzić.",
    },
  },
};
