...
check(
  ...
  "research/property-verification-2026-08-24.md — ΦΜΑ 3% plus a municipal surcharge of 3% of the tax = 3.09%",
...
check(
  ...
  "research/figures-verification-2026-08-23.md — «На уровне €800 000 тот же набор даёт ≈€67 000»",
  gr800.extras,
  67_000,
  1_000,
);
...
check(
  ...
  "research/figures-verification-2026-08-23.md — «Один заявитель до первого продления — ≈€13 470 только пошлин»",
...
check(
  ...
  "research/figures-verification-2026-08-23.md — «≈€126 000 сверх стоимости объекта»",
  mt.extras,
  126_000,
  1,
);
...
check(
  ...
  "research/figures-verification-2026-08-23.md — «Аренда: ≈€113 500 в первый год без гербового сбора»",
  mtRent1.extras,
  113_500,
  1,
);
...
// research/costmodel-verification-2026-09-02.md records it as unresolved.
console.log(
...
console.log(
  "        research/figures-verification-2026-08-23.md — «≈€190–205 тыс. за пять лет аренды». Unresolved;",
);
