...
**Slug:** `property-and-residency-where-it-still-works`
**Language:** en
**Jurisdictions:** Portugal, Greece, Malta, UAE, Cyprus
**Source sections:** pt, gr, mt, ae, cy, citizenship
...
1. `Diagram of five jurisdictions by what a property purchase achieves: Greece and the UAE where it is the route in full, Malta where it is one of five mandatory payments, Portugal where it was abolished in 2023, and Cyprus where no primary source could be read.`
2. `Bar chart of the cost on top of the threshold: Greece about €34,000 at the €400,000 tier and about €67,000 at the €800,000 tier, Malta about €126,000, the UAE about €31,000, Portugal €30,000 to €50,000 for a single applicant.`
3. `Diagram of the Greek zone thresholds: €800,000 across Attica, Thessaloniki, Mykonos, Thira and islands over 3,100 people; €400,000 elsewhere; €250,000 only as an exception for conversions and restorations.`
...
| Jurisdiction | Does buying qualify | Threshold | What is actually required |
| --- | --- | --- | --- |
| Greece | Yes, this is the route | €800,000, €400,000 or €250,000 by zone | One property, at least 120 m² of primary space |
| UAE | Yes, this is the route | AED 2,000,000 (about €466,400 at the rate on 23 August 2026) | One or more completed properties totalling the threshold |
| Malta | Partly: property is required, buying alone is not enough | Purchase €375,000 or rent €14,000 a year | Plus €37,000 contribution, €60,000 fee, €2,000 donation |
| Portugal | No, abolished in 2023 | Route is a €500,000 fund subscription | Non-real-estate fund, minimum five years |
| Cyprus | Not confirmed in a primary source | Dash | See the section below |
...
**Timelines.** The statute (art. 82 of Lei 23/2007) gives 60 days to decide a grant and 30 to decide a renewal, with tacit approval on a renewal where the delay is not the applicant's. In practice a card takes one to three years: submission to biometrics runs 6–24 months, biometrics to card 6–18. As of 4 August 2026, AIMA reports roughly 30,000 pending files. Any article promising "6 to 9 months" is describing the law, not the queue.
...
### Greece golden visa and real estate: property qualifies, at three thresholds
...
| Threshold | Where it applies |
| --- | --- |
| €800,000 | All of Attica, the Thessaloniki regional unit, Mykonos, Thira (Santorini) and islands with a population over 3,100 |
| €400,000 | The rest of Greece |
| €250,000 | Only as an exception: conversion of premises to residential use, reconstruction of an industrial building idle for five years, or full restoration of a listed building |
...
The statutory issuing deadline is two months from the complete file reaching the issuing authority, under article 100 §10 — and the queue has run well past it for years. On filing, a βεβαίωση is issued under article 10 of Law 5038/2023, and that document by itself confers lawful stay and the rights attaching to the permit until a decision is made — so waiting does not mean being out of status. As of November 2025 there were 13,499 pending files, 10,703 of them in Attica, with waits reaching 18 months and now shortening.
...
| Jurisdiction | Threshold | On top | What that covers |
| --- | --- | --- | --- |
| Greece, €400,000 tier | €400,000 | about €34,000 | ΦΜΑ 3.09%, e-paravolo €2,000, card €16 |
| Greece, €800,000 tier | €800,000 | about €67,000 | the same set |
| Malta, purchase | €375,000 | about €126,000 | stamp duty 5%, €60,000 fee, €37,000 contribution, €2,000 NGO, card |
| Malta, rental | €14,000 a year | about €113,500 in year one | no stamp duty |
| UAE | AED 2,000,000 | about €31,000 | fees of AED 9,884.75 plus market 4% and 2% |
| Portugal, fund | €500,000 | €30,000–50,000 for one | AIMA fees, lawyer, fund commissions |

![2]

### Timelines: what is advertised against what happens

| Jurisdiction | Advertised | Actual |
| --- | --- | --- |
| Greece | 2–4 months | Statute gives two months (art. 100 §10); the queue does not — 13,499 files as of November 2025, up to 18 months |
| Portugal | 6–9 months | Statute gives 60 days for a grant; one to three years in practice, about 30,000 files queued |
| Malta | 4–6 months | No published time; 6–12 months end to end |
| UAE | 3–6 weeks | 2–4 weeks from title deed to Emirates ID |
...
**Portugal has stopped being the fast route to a passport.** Lei Orgânica 1/2026 (published 18 May 2026, in force from 19 May) rewrote article 6(1)(b): seven years for citizens of Portuguese-speaking countries and the EU, **ten years for everyone else**. Plus an examination in language and in culture, history and state symbols, plus a solemn declaration. It is not retroactive: files submitted before it came into force are decided under the previous version. Article 5 of the same law also repeals article 15(4), under which the wait for a residence permit had counted towards the period since March 2024 — so for anything filed from 19 May 2026 the queue no longer counts, while a file already pending keeps the old counting.
...
Greece's statute gives two months and its queue held 13,499 files in November 2025. Portugal's statute gives 60 days for a grant but takes one to three years against roughly 30,000 pending files. The UAE takes two to four weeks.

### What else here bears on this

Two of the five jurisdictions in this piece have a guide of their own. What Portugal asks a resident to prove, and what its ten-year citizenship clock changed, is worked through in [the Portugal guide](entry:portugal-residency). What Greece asks, and why permanent residence there counts days rather than permits, is in [the Greece guide](entry:greece-residency). The income question that runs under all five — who tests it, who does not, and what living in each actually costs — is [a piece of its own](entry:income-cost-of-living). The Emirates, the other jurisdiction here where a purchase is the whole route, has [a guide of its own](entry:uae-residency). Malta, where the property is a condition rather than the investment and the real money is the contribution beside it, has [one too](entry:malta-residency). Once a route is chosen, who may file the application and what each portal asks for is in [the application guide](entry:golden-visa-application), and what follows a Portuguese permit — renewals, the card, permanent residence — is in [its own guide](entry:portugal-after-permit). If the phrase itself is the question, [what a golden visa actually is](/golden-visa) is a page of its own. And every act named above, with the date each was read, is on [the sources page](/sources).
...
**Head terms:**
golden visa property, golden visa real estate, residency by investment, residence permit for buying property, golden visa property investment, golden visa for property owners, golden visa through property, buy property and get residency

**Mid-tail:**
which countries give residency for property, buy property get EU residency, golden visa real estate 2026, MPRP Malta requirements, Dubai golden visa 2 million, Portugal golden visa property abolished, EU residence by investment comparison

**Long tail:**
can you rent out golden visa property Greece, Greece golden visa Airbnb ban fine, Greece golden visa 800000 which areas, Greece golden visa 120 sqm minimum, is Portugal golden visa property still available, UAE golden visa off plan property eligible, UAE golden visa mortgage allowed, Greece golden visa total cost beyond threshold, Greece golden visa processing time backlog, Malta MPRP rent versus buy, does Greek golden visa count toward citizenship, AED 750000 golden visa real, Malta MPRP tax residency not included

**Keywords placed in subheadings:**
"the property golden visa is gone" (Portugal), "Greece golden visa and real estate: property qualifies, at three thresholds", "Greek golden visa thresholds by zone", "revocation and a €50,000 fine", "Greek processing times and the full cost", "a ten-year golden visa through property" (UAE), "The full cost: what you need on top of the threshold".

---

## What differs from the Russian version, and why

This is a localisation rather than a translation. The facts are identical — they come from the same file — but the framing, the emphasis and the keyword set are not.

**The audience is different.** The Russian version speaks to a buyer who is already decided on the idea and is choosing a jurisdiction. The English version reaches a wider, less committed audience, and a slice of it is professional: the law firms this site sends enquiries to read English. So the register is a shade more neutral and every claim is stated in a way a lawyer can check in one click.

**Portugal carries more weight here.** In the English-language market the dominant narrative for a decade was "Portugal is the fastest EU passport". Two things broke it — the 2023 removal of property and the May 2026 move to ten years — and English-language listicles still largely repeat the old one. That makes the Portugal section the strongest single reason for an English reader to trust this page over the one above it in the results.

**The competitors are stronger.** Henley & Partners, Global Citizen Solutions and Get Golden Visa all rank on these terms with substantial pages. None of them publishes article numbers with a read date, the total cost on top of the threshold, or the Greek paragraph 7A restrictions. That remains the wedge; it just has to be sharper here.

**Search shape differs.** Russian queries lead with the outcome ("ВНЖ за покупку недвижимости"). English queries lead with the product name ("golden visa") and then qualify by country. Hence "golden visa" appears in more subheadings here than the Russian equivalent does there.
