...
**Slug:** `malta-permanent-residence-programme-cost-and-rules`
**Language:** en
**Jurisdictions:** Malta
**Source sections:** mt, citizenship
**Figures checked:** 1 September 2026
...
1. `Two itemised columns of what one MPRP applicant pays. The purchase route, above the price of the property: 18,750 euros of stamp duty at five per cent of 375,000, a 60,000 euro administrative fee, a 37,000 euro government contribution, a 2,000 euro donation to a non-governmental organisation and a 500 euro residence card, totalling 118,250 euros before notary and legal fees, which bring it to about 126,000. The rental route, first year: 14,000 euros of rent and the same four items, totalling 113,500 euros with no stamp duty.`
2. `Three routes to being in Malta, each drawn as a strip of twelve months. The permanent residence programme: all twelve months empty and dashed, because no rule is published and five official registers were walked without finding one. The nomad residence permit: five of the twelve filled, proved by bank statements showing transactions carried out in Malta. Naturalisation: all twelve filled, being the continuous year immediately before the application, plus four years inside the six preceding it.`
3. `A table of three questions and the instrument that decides each. Whether you may live in Malta: Subsidiary Legislation 217.26. Whether Malta taxes you at all: more than 183 days in a year. What Malta taxes you on: domicile and ordinary residence, meaning worldwide income for those who are both and the remittance basis for anyone who is not one of the two. The permanent residence certificate answers the first question only.`
...
1. **S.L. 217.26 on the government legislation portal** — served through a viewer that returns no text.
2. **The same instrument as Residency Malta publishes it**, the consolidated PDF of February 2025 — no machine-readable text layer.
3. **The handbook for agents** — the subject does not appear. The handbook says at §1.3 that "Should there be conflicting views between this Handbook and the legislation, it is the legislation that prevails", which is an agency pointing at a document you cannot read.
4. **The programme's own frequently-asked-questions PDF** — the document that would have answered it. The agency's link returns **404**; the file has been withdrawn.
5. **Residency Malta's "Compliance" page** — renders "Nothing Found".
...
**Mid-tail:**
malta golden visa cost, malta permanent residence minimum stay, malta tax residence 183 days, malta remittance basis non-dom, malta global residence programme 15 per cent, mprp annual compliance, malta residency for russian citizens

**Questions targeted:** how much does malta permanent residence cost, do you have to live in malta for permanent residence, does mprp give tax residency in malta, how long until maltese citizenship

---

## What differs from the Russian and Polish versions, and why

**The English version leads on the inversion** — the expensive route asks for money and no time, the cheap one asks for time and little money — because the English-language reader arriving here is most often comparing programmes across jurisdictions and has already been shown the entry price of each. The thing they have not been shown is what each one asks of them afterwards.

**The Russian version leads on eligibility**, because for a reader with a Russian or Belarusian passport nothing else on the page matters until that is settled, and the answer is a press release from March 2022 that has never been superseded, withdrawn or turned into a rule. It also carries the Greek comparison at greater length, because those two jurisdictions made the same decision and documented it to two different degrees, and a reader deciding between them is entitled to know that neither can be read as a rule.

**The Polish version is addressed to a third-country national living in Poland**, not to a Polish citizen — a Polish citizen has the right to live in Malta already and needs none of this. So it leads on the comparison that reader actually faces: five years toward EU long-term resident status in Poland, where they already are, against starting that clock again in Malta while paying about €126,000 for the privilege. It carries the Maltese long-term residence conditions under S.L. 217.05 and the point that Malta does not state whether MPRP time counts toward them.
