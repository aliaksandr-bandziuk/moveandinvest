...
Portugal asks a retiree on a D7 to prove €920 a month. It asks an investor who has transferred €500,000 to prove exactly the same €920 a month — and almost every page written about the Portuguese golden visa omits that, because the people writing them sell the service.
...
| No D7 income figure at all, in a ten-thousand-word retirement guide | Get Golden Visa | Two separate cost-of-living sections and no threshold. |
...
How Portugal's €920 compares with what the other four jurisdictions ask, and what living in each of them costs, is in [the income and cost-of-living piece](entry:income-cost-of-living). Whether buying property gets you residency at all — in Portugal it stopped doing so in 2023 — is read against the statute for all five in [the property piece](entry:property-residency). Greece, the one country in this set where property is still the route in full, has [a guide of its own](entry:greece-residency). What happens after the permit — renewal, and permanent residence at five years — is in [its own guide](entry:portugal-after-permit), and what is left of the golden visa is in [the golden visa guide](entry:portugal-golden-visa). What living in Portugal costs, from the figures the state publishes, is in [the cost-of-living guide](entry:portugal-living). For a reader moving from Britain, the 2025 tax treaty that replaced the 1968 one is in [moving to Portugal from the UK](entry:portugal-uk); for an American, the ten-year citizenship clock and the treaty's saving clause are in [moving to Portugal from the US](entry:portugal-americans). Every act named above, with the date each was read, is on [the sources page](/sources).
...
**We do not sell property and we are not lawyers.** This site compares rules and publishes the instrument beside the figure. If you have read the above and want to act on it, the next step is a licensed firm in Portugal, and finding you one is what we do.
...
This is a localisation rather than a translation. The facts are identical and come from `portugal-verification-2026-08-28.md`; the framing and the keyword set are not.

**The English version leads with the golden visa contradiction.** English-language search on this topic is organised around the product name, and the competing pages are consultancies selling that product. The opening therefore puts the €920 that an investor must prove next to the €920 that a retiree must prove, because that single sentence is the thing twelve ranking pages do not say.

**The Russian version leads with the procedure.** Russian search on Portugal is heavier on documents and refusals than on the product name: «какие документы нужны», «без отказа», «причины отказа», «сколько денег на счету». So the Russian version puts the application and the document list earlier and treats the golden visa finding as a section rather than as the opening.

**The Polish version is not about the D7 at all, because a Pole does not need one.** Poles are EU citizens: they register as such and receive a CRUE, with no visa, no AIMA visa file and no income threshold. The Polish version opens by saying so, then covers what a Pole actually does need, and uses the D7 thresholds only as the reference point for a non-EU spouse or parent. It also carries a section on why Poles are buying property abroad in record numbers without moving there, which is a measured fact about the Polish reader that neither other version needs.
