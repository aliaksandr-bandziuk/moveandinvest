...
**Slug:** `golden-passport-and-the-citizenship-clock`
**Language:** en
**Jurisdictions:** Greece, Malta, Portugal, UAE
**Source sections:** gr, mt, pt, ae, citizenship
...
The Greek permit itself — thresholds, zones, the FIP alternative, permanent residence and the 7% pensioner rate — is in [the Greece guide](entry:greece-residency). The Maltese programme, the judgment that ended the passport, and the naturalisation arithmetic in full are in [the Malta guide](entry:malta-residency). Portugal's routes and its naturalisation change are in [the Portugal guide](entry:portugal-residency), and what happens after a Portuguese permit is granted is in [its own guide](entry:portugal-after-permit). The Emirati instruments are in [the UAE guide](entry:uae-residency). Who may file an application in the first place, and what stops one, is in [the application guide](entry:golden-visa-application). And [what a golden visa is](/golden-visa), in the words each state's own law uses, is a page of its own.
